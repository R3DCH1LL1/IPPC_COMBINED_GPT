...
const REPORT_PDF_PATH='/IPPC_Question_Bank_Analytical_Report_V74_Phrasing_Fixed.pdf#toolbar=0&navpanes=0&scrollbar=1';
  ...
  return <div className={`notes-portal-shell theme-${theme}`}>
    <header className="portal-topbar">
      <button className="brand-btn" onClick={onBack}>
        <span className="brand-mark">IPPC</span>
        <span className="brand-sub">V74 Analytical Report</span>
      </button>
    ...
    <iframe className="notes-frame report-frame" title="IPPC V74 Analytical Report" src={REPORT_PDF_PATH} />
  </div>
}
